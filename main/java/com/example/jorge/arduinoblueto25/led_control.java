package com.example.jorge.arduinoblueto25;
...
public class led_control extends AppCompatActivity {
    ...
    Button btnOn, btnOff, btnDis, btnLeft, btnRight;
    SeekBar velocidad;
    TextView lumn;
    String address = null;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        address = newint.getStringExtra(device_list.EXTRA_ADDRESS); //recibimos la mac address obtenida en la actividad anterior
    ...
    private class ConnectBT extends AsyncTask<Void, Void, Void>  // UI thread
    {
        ...
        {
            progress = ProgressDialog.show(led_control.this, "Connecting...", "Please wait!!!");
        }
